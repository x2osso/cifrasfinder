...
<div class="modal fade" id="cadastrarModal"  tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div style="align-items:top;background-color:#373838;color:white;border-radius:12px;" class="modal-dialog modal-lg" role="document">
    ...
    <form action="cadastrar/save_user" name="cadastrarModal" method="post" class="parsley-form">
      <div class="modal-body">
          <div class="container">
              <div class="row">
                  ...
                  <div class="col-sm">
                      <div class="row">
                        <div class="col-md-6 mb-3">
                          ...
                          <input type="" style="height:53px;border-radius:10px" required class="form-control " name="user_name" id="user_name" >
                        </div>
                        <div class="col-md-6 mb-3">
                          <label for="" class="form-label"><h3 style="font-size: 25px;">Instrumento favorito</h3></label>
                          <select style="height:53px;border-radius:10px" class="form-control " name="inst_id" id="inst_id" >
                      ...
                      <div class="mb-3">
                        ...
                        <input type="email" style="height:53px;border-radius:10px" class="form-control " required name="user_email" id="user_email" aria-describedby="emailHelp">
                      </div>
                      <div class="mb-3">
                        <label for="password" class="form-label"><h3>Senha</h3></label>
                        <input type="password" style="height:53px;border-radius:10px" class="form-control " required name="user_password" id="user_password">
                      </div>
                      <div class="mb-3">
                        <label for="exampleFormControlTextarea1" class="form-label"><h3>Biografia</h3></label>
                        <textarea class="form-control" style="border-radius:12px;" name="user_bio" id="user_bio" rows="4"></textarea>
                      </div>
