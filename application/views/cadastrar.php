    ...
    <div class="container">
        <div class="row justify-content-center">
          ...
          <form id="#form_user">
                ...
                <div class="col-10">
                    <div class="col-sm">
                      ...
                      <div class="mb-3" style="text-align:center;">
                        <button type="submit" href="" style="height:80px;border-radius:30px;align:center;" class="btn btn-outline-success"><h5 style="color:white;">Cadastrar</h5></button>
            ...
            <button id="showlogin" style="height:80px;border-radius:30px;align:center;" class="btn btn-outline-info"><h5 style="color:white;">Cadastrar</h5></button>
        </div>
    </div>
</section>
